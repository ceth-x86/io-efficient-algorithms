...
from algorithms.time_forward_processing.maximal_independent_sets import Graph, MaximalIndependentSetSolver
...
```bash
# Run tests
.venv/bin/pytest tests/test_maximal_independent_sets.py -v
```
