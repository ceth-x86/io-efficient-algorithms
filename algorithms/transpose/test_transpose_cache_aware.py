...
class TestTransposeCacheAware:
    ...
    def test_different_block_sizes(self) -> None:
        ...
        disk1 = create_simulator_from_array(a.copy(), block_size=1, memory_size=9)
        ...
        disk2 = create_simulator_from_array(a.copy(), block_size=3, memory_size=9)
        with pytest.raises(NotImplementedError, match="Element-wise transpose not implemented"):
    ...
    def test_different_memory_sizes(self) -> None:
        ...
        disk1 = create_simulator_from_array(a.copy(), block_size=2, memory_size=8)
        with pytest.raises(NotImplementedError, match="Element-wise transpose not implemented"):
            transpose_cache_aware(disk1, 4, 4)

        # Test with large memory (should work)
        disk2 = create_simulator_from_array(a.copy(), block_size=2, memory_size=32)
